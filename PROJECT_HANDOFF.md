...
> **Estado de este documento:** Bloque 16 — selector adaptativo v1 — cerrado, validado y consolidado. Siguiente bloque recomendado: **Bloque 17 — Reto diario v1**.
...
12. selección adaptativa v1 del siguiente escenario a partir de evidencia persistida y de la sesión actual.
...
El selector evita repetir IDs, evita repetir familia inmediata cuando hay alternativas y favorece familias menos vistas. El cierre del Bloque 13 amplió la ventana anti-repetición exacta a 64 IDs y la novedad por firma estructural —familia + variante + timeframe + dirección—. Desde el Bloque 16, estas restricciones conviven con selección adaptativa por skill objetivo y dificultad.
...
Última validación confirmada — Bloque 16:
...
1. **Bloque 17 — Reto diario v1** y primera capa de progresión/retención;

2. revisar después resumen de progreso, rachas u otras señales de retención que premien disciplina/mejora y no volumen de operaciones;
...
- QA/calibración futura del corpus procedural;

- taxonomía final de skills/arquetipos;

- calibración futura de dificultad y selector adaptativo si los datos de uso lo justifican;

- IA;

- diseño exacto del reto diario y de la progresión/retención;
