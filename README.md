...
- selector adaptativo v1 por cobertura, refuerzo, dificultad y diversidad;
...
El Bloque 16 convierte el selector procedural en adaptativo sin IA y sin una nueva migración.
...
2. revisar después si conviene ampliar resumen de progreso, rachas u otras señales de retención sin premiar operar más;
